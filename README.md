...
1. Building a strong LinkedIn profile with a professional banner, profile picture, and impactful headline.
2. Understanding the importance of networking and creating meaningful professional connections.
3. Learning how to design an ATS-friendly resume that effectively highlights skills and achievements.
4. Exploring Git and GitHub fundamentals for version control and project collaboration.
   - Understanding the difference between Git and GitHub.
   - Learning essential Git commands such as Clone, Commit, Push, and Pull.
